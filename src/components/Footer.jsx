                ...
                <div className="mt-[4rem] footer-links w-full flex flex-wrap justify-around py-8">
                    <div className="footer-column w-full sm:w-1/3 mb-8">
                        ...
                        <ul className="text-center">
                            ...
                            <li><a href="/register" className="text-white hover:underline">Cadastrar</a></li>
                        </ul>
                    </div>
                    <div className="footer-column w-full sm:w-1/3 mb-8">
                        <h3 className="text-lg font-bold mb-2 text-center">Compra Segura</h3>
                        <ul className="text-center">
                            <li><a href="/politica-de-cookies" className="text-white hover:underline">Política de cookies</a></li>
                            <li><a href="/termos" className="text-white hover:underline">Termo de Consentimento para Compras Online</a></li>
                            <li><a href="/termos" className="text-white hover:underline">Perguntas Frequentes</a></li>
                        </ul>
                    </div>
                    <div className="footer-column w-full sm:w-1/3 mb-8">
                        <h3 className="text-lg font-bold mb-2 text-center">Contato</h3>
                        <ul className="text-center">
                            <li><a href="/termos" className="text-white hover:underline">Fale Conosco</a></li>
                        </ul>
                    </div>
                </div>
            </div>
