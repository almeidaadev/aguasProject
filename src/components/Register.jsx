        ...
        <div className="max-w-4xl mx-auto h-screen mt-[6rem]">
            ...
            <Card borderBottomColor="border-b-[#0088CC]">
                <div className="flex flex-col items-center justify-center gap-8">
                    ...
                    <button className="px-[5rem] py-[.5rem] bg-[#E0E0E0] text-[#B4B4B4] text-[1.2rem] rounded-[4px] border-2 border-none">CRIAR MINHA CONTA</button>

                    <a href="/login" className="text-[#098CCE]">Já sou cliente</a>
                </div>
            </Card>
        </div>
        </>
